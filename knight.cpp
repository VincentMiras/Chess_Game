...
Knight::Knight(PieceColor color, glm::vec2 pos) : Piece(color,pos){
    ...
    forme = {
        glm::vec3(center_tile_x-0.05f, center_tile_y+0.02f, 0.0f),
        ...
        glm::vec3(center_tile_x-0.01f, center_tile_y-0.07f, 0.0f),
        glm::vec3(center_tile_x+0.05f, center_tile_y+0.02f, 0.0f),
        glm::vec3(center_tile_x-0.01f, center_tile_y+0.02f, 0.0f),
