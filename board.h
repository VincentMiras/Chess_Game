...
public:
    ...
    void initialize();                   // Place les pièces sur l'échiquier
    ...
    void draw(Renderer& renderer, Shader& shader); // Dessine l'échiquier et les pièces

    bool isValidMove(int srcRow, int srcCol, int destRow, int destCol); // Valide un mouvement
};
